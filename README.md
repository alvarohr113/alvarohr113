...
Me apasiona la **ciberseguridad** y el **desarrollo de software**.  
He trabajado en proyectos que van desde **infraestructura como código con Terraform**, **contenedores con Docker** y despliegues en **AWS**, hasta una **aplicación full stack con el stack MERN (MongoDB, Express, React, Node.js)**.
